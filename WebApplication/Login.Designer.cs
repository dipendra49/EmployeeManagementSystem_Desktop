...
namespace LogINForm
{
    partial class Login
    {
        ...
        {
            this.labelLogin = new Wisej.Web.Label();
            this.labelEmail = new Wisej.Web.Label();
            this.labelPassword = new Wisej.Web.Label();
            ...
            this.createAccountBtn = new Wisej.Web.Button();
            this.checkBox = new Wisej.Web.CheckBox();
            this.SuspendLayout();
            // 
            // labelLogin
            // 
        ...
        private Wisej.Web.Label labelLogin;
        private Wisej.Web.Label labelEmail;
        private Wisej.Web.Label labelPassword;
        ...
        private Wisej.Web.Button createAccountBtn;
        private Wisej.Web.CheckBox checkBox;
    }
}
